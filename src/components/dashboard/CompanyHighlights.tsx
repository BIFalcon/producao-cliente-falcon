...
const CompanyHighlights = () => {
  ...
  const { data } = useQuery({
    ...
    queryFn: async () => {
      ...
      const topAbsGrowth = [...filtered].sort((a: any, b: any) => (b.absolute_change || 0) - (a.absolute_change || 0))[0];
      const topAbsDrop = [...filtered].sort((a: any, b: any) => (a.absolute_change || 0) - (b.absolute_change || 0))[0];
      const withPct = filtered.filter((d: any) => d.pct_change !== null);
      const topPctGrowth = [...withPct].sort((a: any, b: any) => (b.pct_change || 0) - (a.pct_change || 0))[0];
      const topPctDrop = [...withPct].sort((a: any, b: any) => (a.pct_change || 0) - (b.pct_change || 0))[0];
