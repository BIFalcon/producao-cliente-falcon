...
const UploadPage = () => {
  ...
  const COLUMN_MAP: Record<string, string> = {
    ...
    'room nights': 'number_of_nights', 'roomnights': 'number_of_nights', 'room night': 'number_of_nights',
    ...
    'food revenue': 'fb_revenue', 'receita alimentos': 'fb_revenue', 'receita de alimentos': 'fb_revenue',
    'diaria media': 'avg_daily_rate', 'diaria media (adr)': 'avg_daily_rate', 'average daily rate': 'avg_daily_rate', 'adr': 'avg_daily_rate',
