...
CREATE OR REPLACE FUNCTION public.get_guest_city_analytics(p_property text DEFAULT NULL::text, p_year integer DEFAULT NULL::integer, p_month integer DEFAULT NULL::integer, p_channel text DEFAULT NULL::text)
...
-- Create guest city drilldown RPC
CREATE OR REPLACE FUNCTION public.get_guest_city_drilldown(p_city text, p_state text DEFAULT NULL::text, p_property text DEFAULT NULL::text, p_year integer DEFAULT NULL::integer, p_month integer DEFAULT NULL::integer, p_channel text DEFAULT NULL::text)
...
-- Update get_dashboard_kpis to accept p_month
CREATE OR REPLACE FUNCTION public.get_dashboard_kpis(p_property text DEFAULT NULL::text, p_year integer DEFAULT NULL::integer, p_channel text DEFAULT NULL::text, p_month integer DEFAULT NULL::integer)
...
BEGIN
  ...
  FROM (
    SELECT
      ...
      LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), ''))) AS norm_text,
      (POSITION('booking' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('expedia' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('decolar' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0) AS has_ota,
      (POSITION('trend' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('cvc' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('latam.travel' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('gol.linhas' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('abreu' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('flytour' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('idt.travel' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('affinity' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('oca.travel' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('tour.house' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('schultz' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('orinter' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('visual.turismo' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('luck.viagens' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('viagens.promo' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('sakura' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('lucky.travel' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('shift.travel' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('tam.viagens' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('newit.turismo' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('klas.turismo' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('azul viagens' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('e-htl' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('ehtl' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
       POSITION('e htl' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0) AS has_operadora,
      ((POSITION('azul linhas aereas' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0 OR
        POSITION('azul linhas global master' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) > 0)
       AND POSITION('azul viagens' IN LOWER(extensions.unaccent(COALESCE(CONCAT_WS(' ', v.company_name, v.travel_agent_name, v.source_name), '')))) = 0)
      AS has_layover,
