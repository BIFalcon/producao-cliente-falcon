...
BEGIN
  ...
  -- Channel mapping: EXCLUDE OTA segment entirely (OTA is hardcoded only)
  ...
  LEFT JOIN tmp_ota_flags ota
    ON ota.confirmation_number = t.confirmation_number AND ota.property_name = t.property_name
