...
BEGIN
  ...
  -- Load channel mapping with normalized canal and standardized segmento
  ...
  -- Also handle "CLUBE DE FERIAS" / "CLUBE DE FÉRIAS"
  ...
  -- Step 1: Find all mapping matches per operational row (non-PM/PF rooms)
  ...
  -- Step 2: Find best (min priority) mapping per reservation
  ...
  -- Step 3: Build operational signals (agent/company/source flags)
  ...
  SELECT
    ...
    CASE
      -- No operational room (only PM/PF/PZ rows)
